This is a five question quiz that tests the user's knowledge on some of the most popular video games. Sound effects have also been added to the program if the user gets a question right or wrong.
